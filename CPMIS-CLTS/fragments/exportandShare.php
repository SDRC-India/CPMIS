...
<div class="exportshare-section">
	...
	<!--<button id="shareBtn" class="btn btn-default btn-sm" type="button"
...
<form id="exportForm" method="post">
		...
		<input type="hidden" name="areaId" value="<?php echo $areaId;?>" id="areaId" /> 
		<input type="hidden" name="indicatorId" value="<?php echo $indicatorId;?>" id="indicatorId" /> 
		<input type="hidden" name="timePeriodId" value="<?php echo $timePeriodId;?>" id="timePeriodId" /> 
		<input type="hidden" name="sourceId" value="<?php echo $sourceId;?>" id="sourceId"/> 
		<input type="hidden" name="childLevel" value="<?php echo $childAreaLevel;?>" id="childLevel" /> 
		<input type="hidden" name="area" value="<?php echo $area;?>" id="area" /> 
		<input type="hidden" name="indicator" value="<?php echo $indicator;?>" id="indicator" /> 
		<input type="hidden" name="timePeriod" value="<?php echo $timePeriod;?>" id="timePeriod" /> 
		<input type="hidden" name="source" value="<?php echo $source;?>" id="source"/> 
		<input type="hidden" name="sectorId" value="<?php echo $sector_Id;?>" id="sectorId" /> 
		<input type="hidden" name="sectorName" value="<?php echo $sector_Name;?>" id="sectorName" /> 
		<!--<input type="hidden" name="secondTimeperiodId" value="<?php //echo $secondTimeperiodId;?>" id="secondTimeperiodId" /> 
		<input type="hidden" name="secondTimeperiod" value="<?php //echo $secondTimeperiod;?>" id="secondTimeperiod" />-->
	...
	<script>
		$(document).ready(
				function() {
					sdrc_export.export_pdf("<?php echo $exportcontainer;?>",
							"pdfDownloadBtn");
				});
	</script>
</div>
