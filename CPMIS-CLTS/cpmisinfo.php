...
<!-- 				</section> -->
				...
				<!--<div class="bihar_line" data-html2canvas-ignore="true"
					...
					<i>Double click on Bihar to view district data</i>
				</div>-->
...
<!-- 									</div> -->
		...
		<script src="angularjs/angular-animate.min.js" type="text/javascript"></script>
		<script src="angularjs/loading-bar.min.js" type="text/javascript"></script>
		<script src="angularjs/d3.min.js" type="text/javascript"></script>

	
	<script src="resources/js/sdrc.dashboard.js" type="text/javascript"></script>
	
	<script src="resources/js/angcontrollers/dashboardctrl_new.js"
