...
<html lang="en">
  <head>
    ...
    <section class="recent-causes section-padding">
        ...
        <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCkOpYJMYHwORuOKp0DwaEnRYzwl8RkJBg&callback"></script>
        ...
        <script>
            function initialize() {
              var mapOptions = {
                zoom: 16,
                scrollwheel: false,
                center: new google.maps.LatLng(25.6047583, 85.1108501)
              };
