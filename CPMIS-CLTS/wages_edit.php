  ...
  <div class="col-md-12">
    <div class="panel panel-primary" data-collapsed="0">
      ...
      <div class="panel-body"> <?php echo form_open('wages_act/wages_act_update/create/'.$row['child_id'], array('class' => 'form-horizontal form-groups-bordered validate project-add', 'enctype' => 'multipart/form-data')); ?>
		...
		<div class="col-sm-6">
            <div class="form-group">
              <label for="field-1" class="col-sm-6 control-label">2.Types of Sectors/Indurstries </label>
              <div class="col-sm-6">
       ...
       <option value="<?php echo $c['id'];?>" <?= ($c['id'] == $row['wages_type'] ? "selected" : "")?>><?php echo $c['sector']; ?></option>
		   ...
		   <div class="col-sm-6">
            <div class="form-group">
              <label for="field-1" class="col-sm-6 control-label">3.Wages Amount </label>
              <div class="col-sm-6">
                
                 <input type="text" readonly class="form-control work_hour" name="work_hour" id="work_hour" value="<?php echo $row['wages_amount']; ?>"> 
		     ...
		     <div class="col-sm-6">
            <div class="form-group">
              <label for="field-1" class="col-sm-6 control-label">4.No of days Work  </label>
              <div class="col-sm-6">
			  <input type="text" class="form-control no_of_days" name="no_of_days" id="no_of_days" oninput="this.value=this.value.replace(/[^0-9]/g,'');" value="<?php echo $row['no_of_days']; ?>">
		  ...
		  <input type ="hidden" name="bal_amount" class ="bal_amount" id="bal_amount" />
		   ...
		   <div class="col-sm-6">
			<div class="form-group">
              <label for="field-1" class="col-sm-6 control-label">5.Total work amount </label>
              <div class="col-sm-6">
		   ...
		   <div class="col-sm-6">
            <div class="form-group">
              <label for="field-1" class="col-sm-6 control-label">6. Salary/Honorarium (Per month) </label>
             <div class="col-sm-6">
	   ...
	   <div class="panel-title ptitle"  > </div>
		    <div class="col-sm-6">
            <div class="form-group">
              <label for="field-1" class="col-sm-6 control-label">7.Amount collected from employer </label>
              <div class="col-sm-6">
                <input type="text"  class="form-control amount_collected" name="amount_collected" oninput="this.value=this.value.replace(/[^0-9]/g,'');" id="amount_collected" value="<?php echo $row['amount_wages_collected']; ?>" />
              </div>
            </div>
          </div>
          <div class="col-sm-6">
            <div class="form-group">
              <label for="field-1" class="col-sm-6 control-label">8.Minimum Wages paid by employer? </label>
              <div class="col-sm-6">
        ...
        <div  id="wages_no">
			  ...
			  <div  id="claim_no">
					<div class="col-sm-6">
					  <label for="field-1" class="col-sm-6 control-label">8 ii. Date on Which the claim was filed</label>
					  <div class="form-group">
						<div class="col-sm-6">
					 ...
					 <div class="row">
					<div class="col-sm-6">
					  <label for="field-1" class="col-sm-6 control-label padd-right" >8 iii. Date on which the claim was disposed off</label>
					  <div class="form-group">
						<div class="col-sm-6">
					...
					<div class="col-sm-6">
					  <label for="field-1" class="col-sm-6 control-label padd-right" >8 iv. Has the claim amount been deposited by the employer? </label>
					  <div class="form-group">
						<div class="col-sm-6">
					 ...
					 <div class="row">
				<div  id="claim_amount_yes">
				  <div class="col-sm-6">
					<label for="field-1" class="col-sm-6 control-label">8 v. Amount of claim received in Rupees</label>
					<div class="form-group">
					  <div id="claim_amount_fr_grp" class="col-sm-6" >
						<input  type="text" class="form-control claim_amount" onkeypress="return isNumberKey(event)" name="claim_amount" id="do_claim"   value="<?php echo $row['claim_amount']; ?>"/>
            <span class="claim_amount_msg color-red"></span>
            	...
            	<div  id="claim_amount_no">
				  <div class="col-sm-6">
					<label for="field-1" class="col-sm-6 control-label">8 v. Has prosecution been filed?</label>
					<div class="form-group" >
					  <div class="col-sm-6">
              ...
              <div  id="prosecutionfield_yes">
                <div class="row">
                  <div class="col-sm-6">
                    <label for="field-1" class="col-sm-6 control-label nleft-margin" >8.v.a. Name and Place of authority to whom prosecution was filed</label>
                    <div class="form-group">
                      <div id="place_authority_fr_grp" class="col-sm-6 padd-right"  >
                  ...
                  <div class="col-sm-6">
                    <label for="field-1" class="col-sm-6 control-label">8.v.b. Date on which prosecution was filed</label>
                    <div class="form-group">
                      <div class="col-sm-6" >
                ...
                <div class="row">
                  <div class="col-sm-6">
                    <label for="field-1" class="col-sm-6 control-label" >8.v.c. Date on which prosecution was disposed off </label>
                    <div class="form-group">
                      <div class="col-sm-6">
                  ...
                  <div class="col-sm-6">
                    <label for="field-1" class="col-sm-6 control-label ">8.v.d. Order Number</label>
                    <div class="form-group">
                      <div id="order_number_fr_grp" class="col-sm-6 new1_padd" >
        ...
        <div class="row">
          <div class="col-sm-6">
            <label for="field-1" class="col-sm-6 control-label">9. Status of Case </label>
            <div class="form-group">
              <div class="col-sm-6" >
          ...
          <div class="row" id="disposed">
            <div class="col-sm-6" >
              <label for="field-1" class="col-sm-6 control-label"> 10.i. Date of Disposal</label>
              <div class="form-group">
                <div class="col-sm-6 new1_padd" >
            ...
            <div class="col-sm-6" >
              <label for="field-1" class="col-sm-6 control-label">10.ii. Type of Disposal</label>
              <div class="form-group">
                <div class="col-sm-6 new2_padd" >
            ...
            <div class="col-sm-6" id="type_other">
              <label for="field-1" class="col-sm-6 control-label">10.ii.a. Please Specify</label>
              <div class="form-group">
          ...
          <div id="pending">
            <div class="col-sm-6" >
              <label for="field-1" class="col-sm-6 control-label">10 i. Reason for Pendency</label>
              <div class="form-group">
...
<script>
  ...
  function isNAN(val){
    ...
    {
    if(jqForm[0].claim_amount.value.length>10)
    {
      flag=1;
    ...
    if(/^\s+$/.test(jqForm[0].claim_amount.value)){
      flag=1;
    ...
    if(/^\s+$/.test(jqForm[0].type_disposed_other.value)){
      ...
      $(".type_of_disposed_other_msg").html("");
		...
		if(claim_filed_date != "" || claim_disposed_date!= ""){
			if(claim_filed_date > claim_disposed_date ){
			$("#error_msg2").html("Claim filed provided should be after disposed date");
