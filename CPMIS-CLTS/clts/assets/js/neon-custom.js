...
;(function($, window, undefined){
	...
	$(document).ready(function()
	{
		...
		if($.isFunction($.fn.slimScroll))
		{
			$(".scrollable").each(function(i, el)
			{
				...
				$this.css({maxHeight: ''}).slimScroll({
					...
					start:attrDefault($this, 'scroll-vertical-position', 'top'),
					height: height,
		...
		// Scrollable from bottom to top ( reverse
		if($.isFunction($.fn.slimScroll))
		{
			$(".scrollable-reverse").each(function(i, el)
			{
				var $this = $(el),
					height = attrDefault($this, 'height', $this.height());
				...
				$this.css({maxHeight: ''}).slimScroll({
					allowPageScroll : true,
					start:attrDefault($this, 'scroll-vertical-position', 'bottom'),
					height: height,
					position: attrDefault($this, 'scroll-position', 'right'),
					color: attrDefault($this, 'rail-color', '#000'),
					size: attrDefault($this, 'rail-width', 6),
				...
				else
				{
					...
					$this.slider({
						...
						slide: function(ev, ui)
						{
							...
							//saving slider value into input box
							document.getElementById('progress_status').value = opts.value;
							$label_1.html( val );
			...
			$(".datepicker").each(function(i, el)
			{
				var $this = $(el),
					opts = {
						...
						endDate: attrDefault($this, 'endDate', 'd'),
