...
//view details child rescued inside state
		...
		public function view_accountrol_details($from,$to,$account_role,$type)
		{
         ...
         public function view_details_outside($from,$to,$type="",$area="")
         {
			 //echo $area_id;
		    $this->load->model('mis_reports_model');
			$data_outside["details_url"]=base_url()."index.php?child_rescued_list/view/";
			
			$data_outside['outside_state_detils']=$this->mis_reports_model->get_details_outside($from,$to,$type,$area);
			//print_r($data_outside['outside_state_detils']);
		 ...
		 public function child_order_after_list($from,$to,$type="",$area="")
		 {
		 	
		 	
		 	$this->load->model('mis_reports_model');
		 	$data_order_after['details_order_after_production']=$this->mis_reports_model->get_details_order($from,$to,$type,$area);
