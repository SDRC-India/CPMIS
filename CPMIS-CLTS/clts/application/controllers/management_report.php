      ...
      public function index()
        {
		 ...
		 $ses_ids=$this->session->userdata('login_user_id');
          ...
          $role=$this->management_report_model->get_role_id($ses_ids);
		  ...
		  if ($_SERVER['REQUEST_METHOD'] == 'POST'){
		        ...
		        $user=2;//LS account_role_id BY default it is loaded
				$type="system_access";
			    ...
			    $management_data_report['type']=$type;
				$management_data_report['selected_user_grp']=$user;
				$management_data_report['from']=$from;
				$management_data_report['to']=$to ;
			 $management_data_report['user_grps']=$this->management_report_model->get_user_groups_list();
             $this->data['title']="Management Reports";
             $this->data['main_content_view'] = $this->load->view('backend/staff/management_report',$management_data_report ,TRUE);
