		...
		<table  class="display table table-bordered" cellspacing="0" width="100%" id="table_export">
			...
			<thead>
				<tr>
					...
					<th style="text-align:center;width:20%;color:#000;">Rescued Date</th>
			...
			<?php  if($child_rescued_district){ $i=1;foreach($child_rescued_district as $row){?>
				...
				<td style="text-align:center;"><a href="<?php echo $childrescue_url.$row['child_id'];?>"><?php echo $row['child_id'] ;?></a></td>
...
<script type="text/javascript">
	jQuery(document).ready(function($)
	{
		...
		window.location.assign('<?php echo base_url(); ?>index.php?mis_reports/user_details/'+from+'/'+to+'/'+type+'/'+area+'/'+export_type);
	...
	{
		type="Report Details of Rescued child";
