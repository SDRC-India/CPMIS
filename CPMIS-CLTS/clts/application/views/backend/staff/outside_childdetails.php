...
foreach($data_list as $row):
    ...
    <tr>
      ...
      <td><?php echo strtoupper($row['village_name'].",".$district.",".$block_name.",".$state);?> </td>
      <td><?php  if (file_exists($path.$row['id'] .'.jpg')) {
				echo '<img src="'.$path.$row['id'].'.jpg" width="150" height="100" />';
			}else{
