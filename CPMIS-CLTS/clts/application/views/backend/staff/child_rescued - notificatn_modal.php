 ...
 <!-------------------------- end of outside state---------------------------->
  ...
  <div class="form-group" style="margin-top:10px;">
    <div class="col-sm-offset-5 col-sm-7">
      <button type="button" class="btn btn-info" id="btnSubmit"> Save</button>
      <button type="button" class="btn btn-info" id="cancel-button"> Cancel</button>
      <span id="preloader-form"></span> </div>
  </div>
  

<div class="modal fade" id="msgModal-11" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog modal-sm">
    <div class="modal-content " >
      ...
      <div class="modal-body text-center">
        <h4 class="text-info">Are U sure want to create</h4>
        <br><br><br>
        <!--<button type="submit" class="btn btn-info"  onclick="window.location.reload(true);" id="submit-button">Yes</button>-->
		<button type="submit" class="btn btn-info" id="submit-button">Yes</button>
	 
		<button onclick="window.location.href='<?php echo base_url();?>index.php?staff/child_rescued_list'" class="btn btn-info">Cancel</button>
      </div>
    </div>
    <!-- /.modal-content -->
  </div>
