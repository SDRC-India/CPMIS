...
<table class="table table-bordered datatable" id="table_export">
  ...
  <thead>
    <tr>
      ...
      <th><div>Whether Child is residing at place where restored </div></th>
  ...
  <tbody>
		...
		$row14	=	$this->db->get_where('child_restoration_status' , array('child_id' => $row['child_id']))->result_array();
		?>
    <tr>
