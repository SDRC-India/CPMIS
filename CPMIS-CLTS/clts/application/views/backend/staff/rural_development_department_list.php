<!------------------------rural dev dept list start------------------------>
<table class="table table-bordered datatable" id="table_export">


	<thead>  
		<tr>
			<th class="table_td_width" style="width:30px;">
				Sl. No.
           	</th>
			<th><div>Child ID</div></th>
			 <th><div>Child Name</div></th>
			<th><div>Is rescued child's family benefiting under MGNREGA </div></th>
			<th><div>Is rescued child's family benefiting under SGSY  </div></th>
			<th><div>Is rescued child's family benefiting under IAY </div></th>
	...
	<tbody>
		<?php 	foreach($rural_development_department_data as $row):
			?>
		<tr>
			...
			<td><?php echo $row['is_mgnrega'];	?>
                    </td>
			<td><?php 	echo $row['is_sgsy']; ?>
                    </td>
			<td>
            	<?php echo $row['is_iay'];?>
           </td>
