		...
		<table  class="display table table-bordered" cellspacing="0" width="100%" id="table_export">
			...
			<thead>
				<tr>
					...
					<th style="text-align:center;width:35%;color:#000;">PERCENTAGE OF PROGRESS</th>
...
window.location.assign('<?php echo base_url(); ?>index.php?mis_reports/child_cwc_progress/'+from+'/'+to+'/'+type+'/'+export_type);
});
	...
	{
		type="No Of Children Need To Progress";
