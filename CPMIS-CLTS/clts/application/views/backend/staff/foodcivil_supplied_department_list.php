...
<table class="table table-bordered datatable" id="table_export">
  ...
  <thead>
    <tr>
      ...
      <th><div>Has Rescued Child's Family been Provided with Ration Card </div></th>
      <th><div>Is Rescued Child's Family Benefited under PDS </div></th>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><a href="<?php echo $detail_url.$row['child_id'];?>"><?php echo $row['child_id'];?></a> </td>
	   <td><?php echo $row['child_name'];?></td>
      <td><?php echo $row['is_ration_card']; ?>
      </td>
      <td><?php 	echo $row['id_pds'];
			?>
      </td>
      <td><?php if($role_id=='8'){?>
