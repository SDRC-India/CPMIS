...
<table class="table table-bordered datatable" id="table_export">
	...
	<td class="table_td_width"><?php echo $counter++;?> </td>
     ...
     <!-- <td><?php //echo $row['incom_expend'] ;  ?></td>
      ...
      <td> <a class="btn btn-info tooltip-primary btn-edit" data-toggle="tooltip" data-placement="top" title="" data-original-title="View" href="<?php echo $details_url.$row['id'];?>"  ><?php  if($roles_id==22){ ?> <i class="entypo-eye"></i><?php }else{ if($row['approve_status']==1){ ?><i class="entypo-eye"></i><?php }else{ ?><i class="entypo-pencil"></i><?php }} ?></a></td>
