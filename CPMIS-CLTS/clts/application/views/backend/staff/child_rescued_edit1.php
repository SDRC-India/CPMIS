            ...
            <div class="form-group" >
              ...
              <div  id="pin_code_fr_grp"  class="col-sm-8 ">
               ...
               <div class="col-sm-8" <?php if($row['state']=='IND010'){ ?> style="display:none;" <?php } ?> id="outside_pincode">
                <input type="text" class="form-control block" maxlength="35"   name="pincode_out" id="pincode_form_grp" autofocus maxlength="6" onkeypress="return isNumberKey(event)"  value="<?php echo $row['pincode'] ; ?>">
            </div>
            </div>
