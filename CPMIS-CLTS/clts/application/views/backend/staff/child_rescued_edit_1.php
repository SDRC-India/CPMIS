    ...
    <div class="panel panel-primary" data-collapsed="0">
      ...
      <div class="panel-body"> <?php echo form_open('child_rescued_list/ChilldRescuedRecord/update/'.$row['child_id'], array('class' => 'form-horizontal form-groups-bordered validate project-add', 'enctype' => 'multipart/form-data', 'name'=> 'basicForm')); ?>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <div class="fileinput fileinput-new" data-provides="fileinput">
                  <div class="fileinput-new thumbnail" data-trigger="fileinput"> <img class="img-thmb"  src="<?php if(file_exists($upload_path.$row['child_id'].'.jpg')) { echo $upload_path.$row['child_id'].'.jpg'; }else{ echo $default;} ?>" alt="..."> </div>
                  ...
                  <div> <span class="btn btn-white btn-file"> <span class="fileinput-new">Change</span> <span class="fileinput-exists">Change</span>
                    <input type="file" name="image" accept="image/*" onchange="return ajaxFileUpload2(this)">
        ...
        <div class="row">
          ...
          <div class="col-sm-6">
            <div class="form-group">
              <label for="field-1" class="col-sm-3 control-label">5.a. Is Date of Birth present </label>
              <div class="col-sm-8">
            ...
            <div class="form-group">
              ...
              <div id="contact_fr_grp" class="col-sm-8">
                <input type="text" class="form-control contact_no" name="contact_no" id="contact_no"
                                value="<?php echo $row['contact_no']; ?>" onkeypress="return isNumberKey(event)" autofocus />
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              <label for="field-1" class="col-sm-3 control-label">16. Block<span class="color-white">*</span></label>
              <div class="col-sm-8">
                <select name="block" class="form-control" id="block" data-validate="required" data-message-required="<?php echo get_phrase('value_required'); ?>" >
                  <option value="" >Select</option>
		  ...
		  <div class="col-sm-6">
            <div class="form-group">
              ...
              <div id="panchayat_name_fr_grp" class="col-sm-8 ">
               <!--<input type="text" class="form-control panchayat_name"  value="<?php echo $row['panchayat_name']?>" name="panchayat_name" id="panchayat_name" 
                                value="" autofocus />
              ...
              <div id="pin_code_fr_grp" class="col-sm-8 ">
               <!--<input type="text" class="form-control pin_code" value="<?php echo $row['pincode']?>" name="pin_code" id="pin_code" 
				...
				<select name="pincode" class="form-control" id="pincode">
                  ...
                  <option value="<?php echo $crow3['id']; ?>" <?php if($row['pincode']==$crow3['id']) echo 'selected';?> ><?php echo $crow3['pincode']; ?></option>
                  <?php  endforeach;  ?>
                </select>
              </div>
            </div>
        ...
        <div class="row">
		  ...
		  <div class="col-md-6">
            <div class="form-group">
              <label for="field-1" class="col-sm-3 control-label">21.a Is Adhar Card Present ?</label>
              <div class="col-sm-8">
          ...
          <div class="col-md-6">
            <div class="form-group">
              <label for="field-1" class="col-sm-3 control-label">21 b.i Enrollment Application No</label>
		  ...
		  <div class="col-md-6">
            <div class="form-group">
              <label for="field-1" class="col-sm-3 control-label">21.b.ii Date Of Enrollment?</label>
			   ...
			   <div class="input-group date" id="datepicker_adhar"> <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                  <input type="text" class="form-control adhar_card_enrollment_date" value="<?php 
				   if($row['adhar_apply_date']!='0000-00-00' ) { echo  $row['adhar_apply_date'];} ?>"   id="adhar_card_enrollment_date" name="adhar_card_enrollment_date"   data-validate="required"  >
                </div>
          ...
          <div class="col-sm-6" id="adhar_card_yes">
            <div class="form-group">
              <label for="field-1" class="col-sm-3 control-label">21.a Adhar Card ID</label>
              <div id="adhar_card_fr_grp" class="col-sm-8">
                <input type="text" class="form-control adhar_card" onkeypress="return isNumberKey(event)" name="adhar_card" id="adhar_card"  value="<?php echo $row['adhar_card']; ?>" autofocus>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-8">
				...
				<option value="">Select</option>
                  ...
                  <option value="CHILD LINE"  <?php if($row['rescue_by']=='CHILD LINE') echo 'selected'; ?>> CHILD LINE </option>
          ...
          <div class="col-sm-6" id="rescue_by_othervalue">
            <div class="form-group">
              <label for="field-1" class="col-sm-3 control-label">22 i: Others(Please Specify)</label>
...
?>
          ...
          <div class="col-sm-6">
            <div class="form-group">
              ...
              <div  id="wcontact_no_fr_grp" class="col-sm-8">
                <input type="text" class="form-control wcontact_no" name="wcontact_no" id="wcontact_no"
                                value="<?php echo $row2['wcontact_no']; ?>"onkeypress="return isNumberKey(event)"  data-validate="required" data-message-required="This field is required" />
        ...
        <div id="addresspresent_no">
          <div class="row">
            ...
            <div class="col-sm-6">
              <div class="form-group">
                <label for="field-1" class="col-sm-3 control-label">4 ii. State</label>
                <div class="col-sm-8">
                  <select name="within_state" class="form-control" id="within_state" data-validate="required">
                      <option value="" >Select</option>
                    <?php  foreach($states_list as $crow9):  ?>
          ...
          <div class="row">
            ...
            <div class="col-sm-6">
              <div class="form-group">
                <label for="field-1" class="col-sm-3 control-label">4 iii.  District</label>
                <div class="col-sm-8">
        ...
        <div class="row" class="padd-top">
          <div class="col-sm-6">
            <div class="form-group top-margin">
              ...
              <div id="iperiod_work_fr_grp" class="col-sm-8 left-margin2 workinvolved_other"   > 5.i. Please Specify
            ...
            <div class="form-group">
              ...
              <div class="col-sm-8">
                <select name="behaviour_of_employer" class="form-control"  id="behaviour_of_employer">
                  ...
                  <option value="Uncordial" <?php if($row2['behaviour_of_employer']=='Uncordial') echo 'selected'; ?>>Uncordial</option>
		   ...
		   <div class="col-sm-6 top-margin">
            <div class="form-group">
              ...
              <div id="name_policestation_fr_grp" class="col-sm-8">
               ...
               <input type="text" class="form-control name_policestation" name="name_policestation" id="name_policestation" value="<?php echo $row2['name_policestation']; ?>" onkeypress="return IsAlphaNumeric(event);" ondrop="return false;" onpaste="return false;" />
          ...
          <div class="col-sm-6">
            <div class="form-group">
              ...
              <div id="salary_fr_grp"  class="col-sm-8"> Amount (In Rs.)
                <input type="text" class="form-control salary" name="salary" id="salary" value="<?php echo $row2['salary']; ?>" onkeypress="return isNumberKey(event)" />
...
?>
            ...
            <div class="form-group">
              ...
              <div id="ocontact_no_fr_grp" class="col-sm-8">
                <input type="text" class="form-control ocontact_no" name="ocontact_no" id="ocontact_no"
                              ...
                              value="<?php echo $row3['ocontact_no']; ?>" onkeypress="return isNumberKey(event)" autofocus />
              ...
              <div class="form-group">
                ...
                <div class="col-sm-8">
                  <select name="outside_state" class="form-control" id="outside_state" data-validate="required">
                    <option value="" >Select</option>
                    <?php foreach($states_list as $crow20):  ?>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-8">
                  <select name="outside_block" class="form-control" id="outside_block">
                    <option value="" >Select</option>
                    <?php   $child_block2 = $this->db->select('*')->where('parent_id',$row3['outside_district'])->order_by('area_name', 'asc')->group_by('area_name')->get('child_area_detail')->result_array();
                              foreach($child_block2 as $crow22):  ?>
                      <option value="<?php echo $crow22['area_id'];?>"  <?php if($row3['outside_block']==$crow22['area_id']){ echo 'selected'; }  ?> ><?php echo $crow22['area_name']; ?></option>
                      <?php endforeach;?>
                  </select>
                </div>
              </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-8">
                <select name="work_involved_outside" class="form-control"  id="work_involved_outside">
                  <option value="">Select</option>
                  <option value="Brick-kiln" <?php if($row3['work_involved_outside']=='Brick-kiln') echo 'selected'; ?>>Brick-kiln</option>
                  <option value="Industries" <?php if($row3['work_involved_outside']=='Industries') echo 'selected'; ?>>Industries</option>
                  <option value="Hotel" <?php if($row3['work_involved_outside']=='Hotel') echo 'selected'; ?>>Hotel/Dhaba</option>
                  <option value="Flat/Houses" <?php if($row3['work_involved_outside']=='Flat/Houses') echo 'selected'; ?>>Flat/Houses</option>
                  <option value="Street Vendor" <?php if($row3['work_involved_outside']=='Street Vendor') echo 'selected'; ?>>Street Vendor</option>
                  <option value="Garage" <?php if($row3['work_involved_outside']=='Garage') echo 'selected'; ?>>Garage</option>
                  <option value="Other" <?php if($row3['work_involved_outside']=='Other') echo 'selected'; ?>>Other</option>
                </select>
              </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-8">
                ...
                <select name="obehaviour_of_employer" class="form-control"  id="obehaviour_of_employer">
                  ...
                  <option value="Uncordial" <?php if($row3['obehaviour_of_employer']=='Uncordial') echo 'selected'; ?>>Uncordial</option>
  ...
  <div class="form-group top-margin" >
    <div class="col-sm-offset-5 col-sm-7">
      ...
      <a href="index.php?child_rescued_list/download_fir/<?php echo $row['child_id']?>" type="button" class="btn btn-info" "> Download FIR</a>
...
if(!/^[1-9][0-9]{5}$/.test(jqForm[0].pin_code.value)){
  ...
  //pincode validation ends
        ...
        if(jqForm[0].contact_no.value.length>20)
        {
          ...
          $(".contact").focus();
          $(".contact_msg").html("This field  should be less than 20 characters");
         return false;
		...
		if(jqForm[0].is_adhar_card.value =="Yes")
		{
			...
			if(jqForm[0].adhar_card.value.length>16)
			{
			  flag=1;
			  $("#adhar_card_fr_grp").addClass("validate-has-error");
			  $(".adhar_card").focus();
			  $(".adhar_card_msg").html("This field should be  16 numeric characters");
			 return false;
...
//production date before CWC
    ...
    if(place == "Within"){
      ...
      if(jqForm[0].wcontact_no.value.length>20)
      {
        flag=1;
        $("#wcontact_no_fr_grp").addClass("validate-has-error");
        $(".wcontact_no").focus();
        $(".wcontact_no_msg").html("This field   should be less than  20 numeric characters");
       return false;
      }
      else{
    ...
    //////////////////////////////////////////////////////////////////
      ...
      //contact number
      if(jqForm[0].ocontact_no.value.length>20)
      {
        flag=1;
        $("#ocontact_no_fr_grp").addClass("validate-has-error");
        $(".ocontact_no").focus();
        $(".ocontact_no_msg").html("This field  should be less than 20 numeric  characters");
       return false;
      }
      else{
