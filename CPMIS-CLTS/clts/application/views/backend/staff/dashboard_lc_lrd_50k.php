...
<table class="table table-bordered datatable" id="table_export">
  ...
  <thead>
    <tr>
      ...
      <th style="text-align:center;color:#000;"><div>Rs 5000 Deposited DCWRA</div></th>
...
window.location.assign('<?php echo base_url(); ?>index.php?dashboard/get_lrd_50k/'+from+'/'+to+'/'+dist+'/'+cond+'/'+cond_val+'/'+export_type);
});
