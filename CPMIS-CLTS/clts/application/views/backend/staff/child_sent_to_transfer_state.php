...
window.location.assign('<?php echo base_url(); ?>index.php?mis_reports/child_transfer_due_state_sent/'+from+'/'+to+'/'+type+'/'+export_type);
});
	...
	{
		type="No Of Children Transferred To Other State";
