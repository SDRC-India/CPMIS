...
window.location.assign('<?php echo base_url(); ?>index.php?mis_reports/forward_cwc/'+from+'/'+to+'/'+type+'/'+export_type);
});
	...
	{
		type="No Of Children Need To Forwared To CWC";
