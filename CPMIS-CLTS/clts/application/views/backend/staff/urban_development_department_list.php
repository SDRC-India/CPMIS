...
<!--edited by prativa-->
  ...
  <thead>
    <tr>
      ...
      <th><div>Is rescued child's family benefiting under SJSRY </div></th>
      <th><div>Is rescued child's family benefiting under  JNURM(Urban area only) </div></th>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><?php echo $row['is_sjsry']; 	?>
      </td>
      <td><?php 	echo $row['is_jnrum'];?>
      </td>
