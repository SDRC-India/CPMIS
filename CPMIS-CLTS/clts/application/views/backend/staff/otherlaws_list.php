...
<table class="table table-bordered datatable" id="table_export">
  <thead>
    <tr>
      ...
      <th><div>Name of Act</div></th>
      <th><div>Section/Sub-section</div></th>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><?php echo $row['act_name1'];?></td>
      <td><?php echo $row['section_name1']; ?>  </td>
      <td><?php 
		if ($role_id==7 ) { ?>
		...
		<?php }else{?>
		<a class="btn btn-info tooltip-primary btn-edit" data-toggle="tooltip" data-placement="top" title="" data-original-title="View"	href="<?php echo $details_url.$row['child_id'];?>" > <i class="entypo-lock"></i> </a>
		<?php }?>
        <?php
		}else if($role_id==18){ ?>
			        <a class="btn btn-info tooltip-primary btn-edit" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit"	href="<?php echo $edit_url.$row['child_id'];?>" > <i class="entypo-lock"></i> </a>
	<?php 	}else {
