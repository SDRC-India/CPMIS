...
<?php
	...
	if($btn_show){
	?>
    <div  class="btn-show pull-right"><a href="<?php echo $url ?>" class="btn btn-info"><?php echo $info;?></a></div>
    <br/>
<?php } ?>
<br/>
<br/>
...
<table class="table table-bordered datatable responsive" id="table_export">
	...
	<thead>
		<tr>
			...
			<th style="width:20%;">Date of demand raised by DM</th>
			<th style="width:20%;"><div>Demand raised letter no</div></th>
			<th style="width:20%;"><div>No. of CL for whom demand raised</div></th>
			<th style="width:20%;"><div>Amount Raised</div></th>
			<th style="width:20%;"><div>Date of demand released</div></th>
			<th style="width:20%;"><div>Letter no. of demand released</div></th>
			<th style="width:20%;"><div>No. of CL for whom demand released</div></th>
			<th style="width:20%;"><div>Amount Released</div></th>
	...
	<tbody>
		...
		<tr>
		   ...
		   <td style="width:20%;"><?php echo $row['dr_date'];?></td>
			<td style="width:20%;"><?php echo $row['dr_letter_no'];?>
                    </td>
			<td style="width:20%;"><?php echo $row['dr_cl_no'];	?> </td>
			<td style="width:20%;"><?php echo $row['dr_amount'];	?> </td>
			<td style="width:20%;"><?php echo $row['drel_date'];	?> </td>
			<td style="width:20%;"><?php echo $row['drel_letter_no'];	?> </td>
			<td style="width:20%;"><?php echo $row['drel_cl_no'];	?> </td>
...
jQuery(document).ready(function($)
	...
	var today = new Date();
			...
			today = dd+'-'+mm+'-'+yyyy;
			var title="CMRF Transaction Details";
	...
	/*	var datatable = $("#table_export").dataTable({
		...
		"dom": 'Bflit'
			...
			window.location.assign('<?php echo base_url(); ?>index.php?cmrf_transaction_details/index/'+export_type);
			});
