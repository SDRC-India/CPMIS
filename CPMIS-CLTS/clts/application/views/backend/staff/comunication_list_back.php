  ...
  <thead>
    <tr>
	 ...
	 <th><div>child Id</div></th>
      <th><div>Date Of communication</div></th>
      <th><div>Replied Message</div></th>
	 ...
	 <?php }?>
	  <?php
     if ($roles==2 ) {?>
      <th class="table_td_width1"><div><?php echo get_phrase('Reply');?></div></th>
	 <?php }?>
    </tr>
  </thead>
  <tbody>
