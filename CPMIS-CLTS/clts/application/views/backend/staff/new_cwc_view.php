...
if(count($data_list)<5){

	echo"<div class='' style='margin-top:-45px;'>".$add_button."</div>";
}
...
<div class="main_data" style="margin-top: 20px;">
<table class="table table-bordered datatable" id="table_export">
	<thead>
		<tr>
			...
			<th><div><?php echo get_phrase('Professional Qualification');?></div></th>
			<th><div><?php echo get_phrase('Address');?></div></th>
			<th><div><?php echo get_phrase('Contact');?></div></th>
			<th><div><?php echo get_phrase('Joining Date');?></div></th>
		<!--  	<th><div><?php echo get_phrase('Release Date');?></div></th>-->
	...
	$counter=1;
		...
		<!--	<td><?php //echo $row['release_date'];?></td>-->
			<td class="view-button">
                              	...
                              	<a href="<?php echo $editmiddle_url.$row['id_cwc_member'];?>" class="btn btn-info">
...
jQuery(document).ready(function($)
		{
			...
			window.location.assign('<?php echo base_url(); ?>index.php?new_cwc/index/'+export_type);
			});
