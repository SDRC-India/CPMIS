...
<table class="table table-bordered datatable" id="table_export">
  <thead>
    <tr>
      ...
      <th><div>Produced by</div></th>
      <th class="view-button"><div><?php echo get_phrase('options');?></div></th>
    </tr>
  </thead>
  <tbody>
    <?php
    ...
    <tr>
      ...
      <td><?php   echo $row['produced'];?></td>
      <td class="view-button"><?php if($row['pstatus']=='N'){?>
...
jQuery(document).ready(function($)
		{
			...
			window.location.assign('<?php echo base_url(); ?>index.php?final_order/index/'+export_type);
			});
