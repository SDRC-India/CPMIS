...
?></td>
          ...
          <table class="table table-bordered table-striped">
			...
			<!-- -------- order type parents---------------------->
			  ...
			  <!-- -------- order type other_place---------------------->
              <tr>
                <td class="t-title">4. Whether registered to Track Child Portal</td>
              ...
              <tr>
                ...
                <td class="t-description"><?php echo $orderrow['cwc_upload']; ?></td>
				<?php /*?><?php if($orderrow['wheather_linked']=='Yes') { ?><?php */?>
                <td class="t-title">5 i. Attach CWC Order</td>
                <td class="t-description">
		  ...
		  ?>
              ...
              <tr>
                ...
                <td class="t-title">ii. Types Of Vocational Training</td>
                <td class="t-description"><?php echo $edurow['vocational_type']; ?></td>
              </tr>
          ...
          <table class="table table-bordered table-striped">
            <tbody>
              <tr>
                <th colspan="8" class="bg-navy"><h3>Act/Compliance</h3></th>
              </tr>
			  ...
			  <?php
		  		...
		  		?>
              <tr>
                <th colspan="8" class="bg-navy"><h5>Compliance by LRD under CLPRA/Apex Court</h5></th>
              </tr>
              <tr>
                <td class="t-title" colspan="3">1. Has Notice been Issued for Compensation of Rs.20,000</td>
                <td class="t-description"><?php echo $labactrow['compensation_notice_issued'];?></td>
                 <td class="t-title">1 i. Letter no.</td>
                <td class="t-description" colspan="3"><?php echo $labactrow['compensation_letter'];?></td>
              </tr>
              <tr>
                <td class="t-title">1 ii. Date of issue</td>
                <td class="t-description"><?php echo $labactrow['date_of_issue'];?></td>
                <td class="t-title" colspan="6"></td>
              </tr>
              <tr>
                <td class="t-title">2. Has Compensation of Rs.20,000 been Deposited</td>
                <td class="t-description" colspan="5"><?php echo $labactrow['compensation_deposited'];?></td>
			  ...
			  <tr>
                ...
                <td class="t-description" colspan="4"><?php echo $labactrow['poceeding_certificate_initiated'];?></td>
              ...
              <tr>
                ...
                <td class="t-title">If Other (Please Specify)</td>
                <td class="t-description" colspan="6"><?php echo $labactrow['poceeding_certificate_authority_other'];?></td>
              </tr>
              <tr>
			...
			?><?php echo $dsts;?></td>
                ...
                <td class="t-description" colspan="3"><?php echo $labactrow['poceeding_certificate_date'];?></td>
                <td class="t-title"></td>
                <td class="t-description">
                
                <?php if (file_exists('uploads/entitlement_proof/labour/act/' .$labactrow['child_id'] . '.jpg')) {
                	echo '<a href="uploads/entitlement_proof/labour/act/'.$labactrow['child_id'].'.jpg"><img src="uploads/entitlement_proof/labour/act/'.$labactrow['child_id'].'.jpg" width="150" height="100" /></a>';
							}else if (file_exists('uploads/entitlement_proof/labour/act/' .$row['child_id'] . '.pdf')){
								echo '<a href="uploads/entitlement_proof/labour/act/'.$labactrow['child_id'].'.pdf"><img src="assets/images/pdf.png"/><span class="color-red">&nbsp;&nbsp;&nbsp;PDF File</span></a>';
							}else if (file_exists('uploads/entitlement_proof/labour/act/' .$labactrow['child_id'] . '.png')){
								echo '<a href="uploads/entitlement_proof/labour/act/'.$labactrow['child_id'].'.png"><img src="uploads/entitlement_proof/labour/act/'.$labactrow['child_id'].'.png" width="150" height="100" /></a>';
							}else if (file_exists('uploads/entitlement_proof/labour/act/' .$labactrow['child_id'] . '.pdf')){
								echo '<a href="uploads/entitlement_proof/labour/act/'.$labactrow['child_id'].'.pdf"><img src="uploads/pdf-image" width="150" height="100" /></a>';
							}else{
								echo 'No Proof Attached';
							}
						?>		
              ...
              <tr>
                ...
                <td class="t-description" colspan="3"><?php echo $labactrow['prosecution_file_date'];?></td>
              </tr>
			  <?php }
			  }?>
              <tr>
                <td class="t-title">3. Has prosecution been filed(under Child Labour Act)</td>
                <td class="t-description" colspan="2"><?php echo $labactrow['has_prosecution_file'];?></td>
                <td class="t-title" colspan="6"></td>
              </tr>
			  <?php
              ...
              <tr>
                ...
                <td class="t-description1" colspan="2"><?php echo $labactrow['prosecution_file_authority'];?></td>
                <td class="t-title" colspan="4">If Other (Please Specify)</td>
                <td class="t-description" colspan="3"><?php echo $labactrow['prosecution_file_other'];?></td>
              </tr>
              <tr>
                ...
                <td class="t-description1" colspan="3"><?php echo $labactrow['prosecution_file_date'];?></td>
              </tr>
			 ...
			 <?php  if($labactrow['status_of_cases'] =="Disposed") {?>
              <tr>
                ...
                <td class="t-description" colspan="5"><?php echo $labactrow['type_of_disposed'];?></td>
              </tr>
              <tr>
                <td class="t-title" colspan="2"></td>
                <td class="t-title">If Other (Please Specify)</td>
                <td class="t-description" colspan="6"><?php echo $labactrow['type_of_disposed_other'];?></td>
              </tr>
			  <tr>
				...
				<td class="t-title"></td>
                <td class="t-description" colspan="6"></td>
              </tr>
			  <?php } ?>
              <!-- if pending -->
			 <?php  if($labactrow['status_of_cases'] =="Pending") {?>
              <tr>
                ...
                <td class="t-description" colspan="5"><?php echo $labactrow['reason_pendency'];?></td>
              </tr>
			  <?php } ?>
			  <?php endforeach;?>
			  ...
			  <?php
		  		...
		  		?>
              <tr>
                <th colspan="8" class="bg-navy"><h5>Compliance by LRD on Minimum Wages Act</h5></th>
              </tr>
              <tr>
			  ...
			  foreach($row151 as $data):
               ...
               <?php foreach($wages_name as $wages_row): ?>
                ...
                <td class="t-description" colspan="6"><?php echo $wages_row['sector'] ;?></td>
				<?php endforeach;  ?>
              </tr>
              <tr>
                ...
                <td class="t-description" colspan="6"><?php echo $no_of_days ; ?></td>
              </tr>
			   <tr>
                ...
                <td class="t-description" colspan="6"><?php if($sal!=""){ echo "INR ".$sal; }else{ echo "Not Available" ; } ?></td>     
              </tr>
			  <tr>
              ...
              <tr>
                ...
                <td class="t-description" colspan="6"><?php echo $wactrow['date_disposed'];?></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td class="t-title">4 ii. Type of Disposal</td>
                <td class="t-description" colspan="6"><?php echo $wactrow['type_disposed'];?></td>
              </tr>
              <tr>
                <td class="t-title" colspan="2"></td>
                <td class="t-title">4.ii.a. If Other (Please Specify)</td>
                <td class="t-description" colspan="6" ><?php echo $wactrow['type_disposed_other'];?></td>
              </tr>
		  	...
		  	?>
              <tr>
                <th colspan="8" class="bg-navy"><h5>IPC Act</h5></th>
              </tr>
              <tr>
			 ...
			 $section_newid	=	$this->db->get_where('sections' , array('id' => $section_id))->result_array();
                ...
                <td class="t-description" colspan="6"><?php echo $ipcrow['remarks'];?></td>
              </tr>
			  <?php endforeach;?>
		  	...
		  	?>
              <tr>
                <th colspan="8" class="bg-navy"><h5>Other Laws Act</h5></th>
              </tr>
              <tr>
                ...
                <td class="t-description" colspan="6"><?php echo $otherrow['section_name1'];?></td>
              </tr>
              <tr>
                ...
                <td class="t-description" colspan="6"><?php echo $otherrow['section_name2'];?></td>
              </tr>
              <tr>
                ...
                <td class="t-description" colspan="6"><?php echo $otherrow['section_name3'];?></td>
              </tr>
			  <?php endforeach;?>
			 ...
			 <?php
		 	 ...
		 	 $row17	=	$this->db->get_where('upload_fir' , array('child_id' => $row['child_id']))->result_array();
		 	 foreach($row17 as $otherrow):
		  	?>
              <tr>
                <th colspan="8" class="bg-navy"><h5>Upload FIR</h5></th>
              </tr>
              <tr>
                <td class="t-title">1. Do you want to upload the original FIR copy ? </td>
                <td class="t-description" colspan="8"><?php echo $otherrow['upload_fir_status'];?></td>
              </tr>
              <tr>
                <td class="t-title">1 i. Attach Proof</td>
                <td class="t-description" colspan="8"><?php if (file_exists('uploads/entitlement_proof/Uploadfir/q1/' .$row['child_id'] . '.jpg')) {
			...
			?>
              ...
              <tr>
				...
				<?php if (file_exists('uploads/entitlement_proof/edu_image/' .$edudeptrow['child_id'] . '.jpg')) {
					echo "<a href='uploads/entitlement_proof/edu_image/".$edudeptrow['child_id'].".jpg' target='_blank'><img width='100px' src='uploads/entitlement_proof/edu_image/".$edudeptrow['child_id'].".jpg'  /></a>";
						}else if (file_exists('uploads/entitlement_proof/edu_image/' .$edudeptrow['child_id'] . '.pdf')){
							echo  "<a href='uploads/entitlement_proof/edu_image/".$edudeptrow['child_id'].".pdf' target='_blank'><img width='100px' src='assets/images/pdf.png'  /></a>";
						}else if (file_exists('uploads/entitlement_proof/edu_image/' .$edudeptrow['child_id'] . '.png')){
							echo  "<a href='uploads/entitlement_proof/edu_image/".$edudeptrow['child_id'].".png' target='_blank'><img width='100px' src='uploads/entitlement_proof/edu_image/".$edudeptrow['child_id'].".png'  /></a>";
						}else{
							echo 'No Proof Attached';
						}
              ...
              <tr>
				...
				<?php if (file_exists('uploads/entitlement_proof/rural/q1/' .$ruraldeptrow['child_id'] . '.jpg')) {
					echo "<a href='uploads/entitlement_proof/rural/q1/".$ruraldeptrow['child_id'].".jpg' target='_blank'><img width='100px' src='uploads/entitlement_proof/rural/q1/".$ruraldeptrow['child_id'].".jpg'  /></a>";
						}else if (file_exists('uploads/entitlement_proof/rural/q1/' .$ruraldeptrow['child_id'] . '.pdf')){
							echo  "<a href='uploads/entitlement_proof/rural/q1/".$ruraldeptrow['child_id'].".pdf' target='_blank'><img width='100px' src='assets/images/pdf.png'  /></a>";
						}else if (file_exists('uploads/entitlement_proof/rural/q1/' .$ruraldeptrow['child_id'] . '.png')){
							echo  "<a href='uploads/entitlement_proof/rural/q1/".$ruraldeptrow['child_id'].".png' target='_blank'><img width='100px' src='uploads/entitlement_proof/rural/q1/".$ruraldeptrow['child_id'].".png'  /></a>";
						}else{
						echo 'No Proof Attached';
						}
					}
              ...
              <tr>
				...
				<?php if (file_exists('uploads/entitlement_proof/rural/q2/' .$ruraldeptrow['child_id'] . '.jpg')) {
					echo "<a href='uploads/entitlement_proof/rural/q2/".$ruraldeptrow['child_id'].".jpg' target='_blank'><img width='100px' src='uploads/entitlement_proof/rural/q2/".$ruraldeptrow['child_id'].".jpg'  /></a>";
						}else if (file_exists('uploads/entitlement_proof/rural/q2/' .$ruraldeptrow['child_id'] . '.pdf')){
							echo  "<a href='uploads/entitlement_proof/rural/q2/".$ruraldeptrow['child_id'].".pdf' target='_blank'><img width='100px' src='assets/images/pdf.png'  /></a>";
						}else if (file_exists('uploads/entitlement_proof/rural/q2/' .$ruraldeptrow['child_id'] . '.png')){
							echo  "<a href='uploads/entitlement_proof/rural/q2/".$ruraldeptrow['child_id'].".png' target='_blank'><img width='100px' src='uploads/entitlement_proof/rural/q2/".$ruraldeptrow['child_id'].".png'  /></a>";
						}
						else{
							echo 'No Proof Attached';
						}
              ...
              <tr>
				...
				<?php if (file_exists('uploads/entitlement_proof/rural/q3/' .$ruraldeptrow['child_id'] . '.jpg')) {
					echo "<a href='uploads/entitlement_proof/rural/q3/".$ruraldeptrow['child_id'].".jpg' target='_blank'><img width='100px' src='uploads/entitlement_proof/rural/q3/".$ruraldeptrow['child_id'].".jpg'  /></a>";
						}else if (file_exists('uploads/entitlement_proof/rural/q3/' .$ruraldeptrow['child_id'] . '.pdf')){
							echo  "<a href='uploads/entitlement_proof/rural/q3/".$ruraldeptrow['child_id'].".pdf' target='_blank'><img width='100px' src='assets/images/pdf.png'  /></a>";
						}else if (file_exists('uploads/entitlement_proof/rural/q3/' .$ruraldeptrow['child_id'] . '.png')){
							echo  "<a href='uploads/entitlement_proof/rural/q3/".$ruraldeptrow['child_id'].".png' target='_blank'><img width='100px' src='uploads/entitlement_proof/rural/q3/".$ruraldeptrow['child_id'].".png'  /></a>";
						}
						else{
							echo 'No Proof Attached';
						}
              ...
              <tr>
				...
				<?php if (file_exists('uploads/entitlement_proof/urban/q1/' .$urdeptrow['child_id'] . '.jpg')) {
					       echo "<a href='uploads/entitlement_proof/urban/q1/".$urdeptrow['child_id'].".jpg' target='_blank'><img width='100px' src='uploads/entitlement_proof/urban/q1/".$urdeptrow['child_id'].".jpg'  /></a>";
						}else if (file_exists('uploads/entitlement_proof/urban/q1/' .$urdeptrow['child_id'] . '.pdf')){
							echo  "<a href='uploads/entitlement_proof/urban/q1/".$urdeptrow['child_id'].".pdf' target='_blank'><img width='100px' src='assets/images/pdf.png'  /></a>";
						}else if (file_exists('uploads/entitlement_proof/urban/q1/' .$urdeptrow['child_id'] . '.png')){
							echo  "<a href='uploads/entitlement_proof/urban/q1/".$urdeptrow['child_id'].".png' target='_blank'><img width='100px' src='uploads/entitlement_proof/urban/q1/".$urdeptrow['child_id'].".png'  /></a>";
						}else{
							echo 'No Proof Attached';
						}
              ...
              <tr>
				...
				<?php if (file_exists('uploads/entitlement_proof/urban/q2/' .$urdeptrow['child_id'] . '.jpg')) {
					echo "<a href='uploads/entitlement_proof/urban/q2/".$urdeptrow['child_id'].".jpg' target='_blank'><img width='100px' src='uploads/entitlement_proof/urban/q2/".$urdeptrow['child_id'].".jpg'  /></a>";
						}else if (file_exists('uploads/entitlement_proof/urban/q2/' .$urdeptrow['child_id'] . '.pdf')){
							echo  "<a href='uploads/entitlement_proof/urban/q2/".$urdeptrow['child_id'].".pdf' target='_blank'><img width='100px' src='assets/images/pdf.png'  /></a>";
						}else if (file_exists('uploads/entitlement_proof/urban/q2/' .$urdeptrow['child_id'] . '.png')){
							echo  "<a href='uploads/entitlement_proof/urban/q2/".$urdeptrow['child_id'].".png' target='_blank'><img width='100px' src='uploads/entitlement_proof/urban/q2/".$urdeptrow['child_id'].".png'  /></a>";
						}
						else{
							echo 'No Proof Attached';
						}
              ...
              <tr>
				...
				<?php if (file_exists('uploads/entitlement_proof/revenue/' .$revdeptrow['child_id'] . '.jpg')) {
					echo "<a href='uploads/entitlement_proof/revenue/".$revdeptrow['child_id'].".jpg' target='_blank'><img width='100px' src='uploads/entitlement_proof/revenue/".$revdeptrow['child_id'].".jpg'  /></a>";
						}else if (file_exists('uploads/entitlement_proof/revenue/' .$revdeptrow['child_id'] . '.pdf')){
							echo  "<a href='uploads/entitlement_proof/revenue/".$revdeptrow['child_id'].".pdf' target='_blank'><img width='100px' src='assets/images/pdf.png'  /></a>";
						}else if (file_exists('uploads/entitlement_proof/revenue/' .$revdeptrow['child_id'] . '.png')){
							echo  "<a href='uploads/entitlement_proof/revenue/".$revdeptrow['child_id'].".png' target='_blank'><img width='100px' src='uploads/entitlement_proof/revenue/".$revdeptrow['child_id'].".png'  /></a>";
						}
						else{
							echo 'No Proof Attached';
						}
              ...
              <tr>
				...
				<?php if (file_exists('uploads/entitlement_proof/revenue/parcha/' .$revdeptrow['child_id'] . '.jpg')) {
					echo "<a href='uploads/entitlement_proof/revenue/parcha/".$revdeptrow['child_id'].".jpg' target='_blank'><img width='100px' src='uploads/entitlement_proof/revenue/parcha/".$revdeptrow['child_id'].".jpg'  /></a>";
						}else if (file_exists('uploads/entitlement_proof/revenue/parcha/' .$revdeptrow['child_id'] . '.pdf')){
							echo  "<a href='uploads/entitlement_proof/revenue/parcha/".$revdeptrow['child_id'].".pdf' target='_blank'><img width='100px' src='assets/images/pdf.png'  /></a>";
						}else if (file_exists('uploads/entitlement_proof/revenue/parcha/' .$revdeptrow['child_id'] . '.png')){
							echo  "<a href='uploads/entitlement_proof/revenue/parcha/".$revdeptrow['child_id'].".png' target='_blank'><img width='100px' src='uploads/entitlement_proof/revenue/parcha/".$revdeptrow['child_id'].".png'  /></a>";
						}
						else{
							echo 'No Proof Attached';
						}
              ...
              <tr>
				...
				<?php if (file_exists('uploads/entitlement_proof/health/' .$hdeptrow['child_id'] . '.jpg')) {
					echo "<a href='uploads/entitlement_proof/health/".$hdeptrow['child_id'].".jpg' target='_blank'><img width='100px' src='uploads/entitlement_proof/health/".$hdeptrow['child_id'].".jpg'  /></a>";
						}else if (file_exists('uploads/entitlement_proof/health/' .$hdeptrow['child_id'] . '.pdf')){
							echo  "<a href='uploads/entitlement_proof/health/".$hdeptrow['child_id'].".pdf' target='_blank'><img width='100px' src='assets/images/pdf.png'  /></a>";
						}else if (file_exists('uploads/entitlement_proof/health/' .$hdeptrow['child_id'] . '.png')){
							echo  "<a href='uploads/entitlement_proof/health/".$hdeptrow['child_id'].".png' target='_blank'><img width='100px' src='uploads/entitlement_proof/health/".$hdeptrow['child_id'].".png'  /></a>";
						}else{
							echo 'No Proof Attached';
						}
					}
              ...
              <tr>
				...
				<?php if (file_exists('uploads/entitlement_proof/scst/' .$scdeptrow['child_id'] . '.jpg')) {
					echo "<a href='uploads/entitlement_proof/scst/".$scdeptrow['child_id'].".jpg' target='_blank'><img width='100px' src='uploads/entitlement_proof/scst/".$scdeptrow['child_id'].".jpg'  /></a>";
						}else if (file_exists('uploads/entitlement_proof/scst/' .$scdeptrow['child_id'] . '.pdf')){
							echo  "<a href='uploads/entitlement_proof/scst/".$scdeptrow['child_id'].".pdf' target='_blank'><img width='100px' src='assets/images/pdf.png'  /></a>";
						}else if (file_exists('uploads/entitlement_proof/scst/' .$scdeptrow['child_id'] . '.png')){
							echo  "<a href='uploads/entitlement_proof/scst/".$scdeptrow['child_id'].".png' target='_blank'><img width='100px' src='uploads/entitlement_proof/scst/".$scdeptrow['child_id'].".png'  /></a>";
						}
						else{
							echo 'No Proof Attached';
						}
              ...
              <tr>
				...
				<?php if (file_exists('uploads/entitlement_proof/food/q1/' .$fdeptrow['child_id'] . '.jpg')) {
					echo "<a href='uploads/entitlement_proof/food/q1/".$fdeptrow['child_id'].".jpg' target='_blank'><img width='100px' src='uploads/entitlement_proof/food/q1/".$fdeptrow['child_id'].".jpg'  /></a>";
						}else if (file_exists('uploads/entitlement_proof/food/q1/' .$fdeptrow['child_id'] . '.pdf')){
							echo  "<a href='uploads/entitlement_proof/food/q1/".$fdeptrow['child_id'].".pdf' target='_blank'><img width='100px' src='assets/images/pdf.png'  /></a>";
						}else if (file_exists('uploads/entitlement_proof/food/q1/' .$fdeptrow['child_id'] . '.png')){
							echo  "<a href='uploads/entitlement_proof/food/q1/".$fdeptrow['child_id'].".png' target='_blank'><img width='100px' src='uploads/entitlement_proof/food/q1/".$fdeptrow['child_id'].".png'  /></a>";
						}
						else{
							echo 'No Proof Attached';
						}
              ...
              <tr>
				...
				<?php if (file_exists('uploads/entitlement_proof/food/q2/' .$fdeptrow['child_id'] . '.jpg')) {
					echo "<a href='uploads/entitlement_proof/food/q2/".$fdeptrow['child_id'].".jpg' target='_blank'><img width='100px' src='uploads/entitlement_proof/food/q2/".$fdeptrow['child_id'].".jpg'  /></a>";
						}else if (file_exists('uploads/entitlement_proof/food/q2/' .$fdeptrow['child_id'] . '.pdf')){
							echo  "<a href='uploads/entitlement_proof/food/q2/".$fdeptrow['child_id'].".pdf' target='_blank'><img width='100px' src='assets/images/pdf.png'  /></a>";
						}else if (file_exists('uploads/entitlement_proof/food/q2/' .$fdeptrow['child_id'] . '.png')){
							echo  "<a href='uploads/entitlement_proof/food/q2/".$fdeptrow['child_id'].".png' target='_blank'><img width='100px' src='uploads/entitlement_proof/food/q2/".$fdeptrow['child_id'].".png'  /></a>";
						}else{
							echo 'No Proof Attached';
						}
					}
              ...
              <tr>
				...
				<?php if (file_exists('uploads/entitlement_proof/minority/q1/' .$mdeptrow['child_id'] . '.jpg')) {
					echo "<a href='uploads/entitlement_proof/minority/q1/".$mdeptrow['child_id'].".jpg' target='_blank'><img width='100px' src='uploads/entitlement_proof/minority/q1/".$mdeptrow['child_id'].".jpg'  /></a>";
						}else if (file_exists('uploads/entitlement_proof/minority/q1/' .$mdeptrow['child_id'] . '.pdf')){
							echo  "<a href='uploads/entitlement_proof/minority/q1/".$mdeptrow['child_id'].".pdf' target='_blank'><img width='100px' src='assets/images/pdf.png'  /></a>";
						}else if (file_exists('uploads/entitlement_proof/minority/q1/' .$mdeptrow['child_id'] . '.png')){
							echo  "<a href='uploads/entitlement_proof/minority/q1/".$mdeptrow['child_id'].".png' target='_blank'><img width='100px' src='uploads/entitlement_proof/minority/q1/".$mdeptrow['child_id'].".png'  /></a>";
						}else{
							echo 'No Proof Attached';
						}
					}
              ...
              <tr>
				...
				<?php if (file_exists('uploads/entitlement_proof/minority/q2/' .$mdeptrow['child_id'] . '.jpg')) {
					echo "<a href='uploads/entitlement_proof/minority/q2/".$mdeptrow['child_id'].".jpg' target='_blank'><img width='100px' src='uploads/entitlement_proof/minority/q2/".$mdeptrow['child_id'].".jpg'  /></a>";
						}else if (file_exists('uploads/entitlement_proof/minority/q2/' .$mdeptrow['child_id'] . '.pdf')){
							echo  "<a href='uploads/entitlement_proof/minority/q2/".$mdeptrow['child_id'].".pdf' target='_blank'><img width='100px' src='assets/images/pdf.png'  /></a>";
						}else if (file_exists('uploads/entitlement_proof/minority/q2/' .$mdeptrow['child_id'] . '.png')){
							echo  "<a href='uploads/entitlement_proof/minority/q2/".$mdeptrow['child_id'].".png' target='_blank'><img width='100px' src='uploads/entitlement_proof/minority/q2/".$mdeptrow['child_id'].".png'  /></a>";
						}else{
							echo 'No Proof Attached';
						}
						}
              ...
              <tr>
                <td class="t-title">3. Is the rescued child's family getting additional loan if they are willing to take it ?</td>
                <td class="t-description"><?php echo $mdeptrow['additional_loan'];?></td>
                <td class="t-title">Attach Proof </td>
                <td class="t-description">
				<?php if($mdeptrow['is_loan'] =='Yes') { ?>
				<?php if (file_exists('uploads/entitlement_proof/minority/q3/' .$mdeptrow['child_id'] . '.jpg')) {
					echo "<a href='uploads/entitlement_proof/minority/q3/".$mdeptrow['child_id'].".jpg' target='_blank'><img width='100px' src='uploads/entitlement_proof/minority/q3/".$mdeptrow['child_id'].".jpg'  /></a>";
						}else if (file_exists('uploads/entitlement_proof/minority/q3/' .$mdeptrow['child_id'] . '.pdf')){
							echo  "<a href='uploads/entitlement_proof/minority/q3/".$mdeptrow['child_id'].".pdf' target='_blank'><img width='100px' src='assets/images/pdf.png'  /></a>";
						}else if (file_exists('uploads/entitlement_proof/minority/q3/' .$mdeptrow['child_id'] . '.png')){
							echo  "<a href='uploads/entitlement_proof/minority/q3/".$mdeptrow['child_id'].".png' target='_blank'><img width='100px' src='uploads/entitlement_proof/minority/q3/".$mdeptrow['child_id'].".png'  /></a>";
						}else{
							echo 'No Proof Attached';
						}
						}
              ...
              <tr>
				...
				<?php if (file_exists('uploads/entitlement_proof/social/q1/' .$sdeptrow['child_id'] . '.jpg')) {
					echo "<a href='uploads/entitlement_proof/social/q1/".$sdeptrow['child_id'].".jpg' target='_blank'><img width='100px' src='uploads/entitlement_proof/social/q1/".$sdeptrow['child_id'].".jpg'  /></a>";
						}else if (file_exists('uploads/entitlement_proof/social/q1/' .$sdeptrow['child_id'] . '.pdf')){
							echo  "<a href='uploads/entitlement_proof/social/q1/".$sdeptrow['child_id'].".pdf' target='_blank'><img width='100px' src='assets/images/pdf.png'  /></a>";
						}else if (file_exists('uploads/entitlement_proof/social/q1/' .$sdeptrow['child_id'] . '.png')){
							echo  "<a href='uploads/entitlement_proof/social/q1/".$sdeptrow['child_id'].".png' target='_blank'><img width='100px' src='uploads/entitlement_proof/social/q1/".$sdeptrow['child_id'].".png'  /></a>";
						}else{
							echo 'No Proof Attached';
						}
					}
              ...
              <tr>
				...
				<?php if (file_exists('uploads/entitlement_proof/social/q2/' .$sdeptrow['child_id'] . '.jpg')) {
					echo "<a href='uploads/entitlement_proof/social/q2/".$sdeptrow['child_id'].".jpg' target='_blank'><img width='100px' src='uploads/entitlement_proof/social/q2/".$sdeptrow['child_id'].".jpg'  /></a>";
						}else if (file_exists('uploads/entitlement_proof/social/q2/' .$sdeptrow['child_id'] . '.pdf')){
							echo  "<a href='uploads/entitlement_proof/social/q2/".$sdeptrow['child_id'].".pdf' target='_blank'><img width='100px' src='assets/images/pdf.png'  /></a>";
						}else if (file_exists('uploads/entitlement_proof/social/q2/' .$sdeptrow['child_id'] . '.png')){
							echo  "<a href='uploads/entitlement_proof/social/q2/".$sdeptrow['child_id'].".png' target='_blank'><img width='100px' src='uploads/entitlement_proof/social/q2/".$sdeptrow['child_id'].".png'  /></a>";
						}else{
							echo 'No Proof Attached';
						}
						}
              ...
              <tr>
				...
				<?php if (file_exists('uploads/entitlement_proof/social/q3/' .$sdeptrow['child_id'] . '.jpg')) {
					echo "<a href='uploads/entitlement_proof/social/q3/".$sdeptrow['child_id'].".jpg' target='_blank'><img width='100px' src='uploads/entitlement_proof/social/q3/".$sdeptrow['child_id'].".jpg'  /></a>";
						}else if (file_exists('uploads/entitlement_proof/social/q3/' .$sdeptrow['child_id'] . '.pdf')){
							echo  "<a href='uploads/entitlement_proof/social/q3/".$sdeptrow['child_id'].".pdf' target='_blank'><img width='100px' src='assets/images/pdf.png'  /></a>";
						}else if (file_exists('uploads/entitlement_proof/social/q3/' .$sdeptrow['child_id'] . '.png')){
							echo  "<a href='uploads/entitlement_proof/social/q3/".$sdeptrow['child_id'].".png' target='_blank'><img width='100px' src='uploads/entitlement_proof/social/q3/".$sdeptrow['child_id'].".png'  /></a>";
						}else{
							echo 'No Proof Attached';
						}
						}
              ...
              <tr>
				...
				<?php if (file_exists('uploads/entitlement_proof/social/q4/' .$sdeptrow['child_id'] . '.jpg')) {
					echo "<a href='uploads/entitlement_proof/social/q4/".$sdeptrow['child_id'].".jpg' target='_blank'><img width='100px' src='uploads/entitlement_proof/social/q3/".$sdeptrow['child_id'].".jpg'  /></a>";
						}else if (file_exists('uploads/entitlement_proof/social/q4/' .$sdeptrow['child_id'] . '.pdf')){
							echo  "<a href='uploads/entitlement_proof/social/q4/".$sdeptrow['child_id'].".pdf' target='_blank'><img width='100px' src='assets/images/pdf.png'  /></a>";
						}else if (file_exists('uploads/entitlement_proof/social/q4/' .$sdeptrow['child_id'] . '.png')){
							echo  "<a href='uploads/entitlement_proof/social/q4/".$sdeptrow['child_id'].".png' target='_blank'><img width='100px' src='uploads/entitlement_proof/social/q4/".$sdeptrow['child_id'].".png'  /></a>";
						}else{
							echo 'No Proof Attached';
						}
						}
