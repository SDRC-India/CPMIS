...
<div class="row child_rescued">
  <div class="col-md-12">
    <div class="panel panel-primary" data-collapsed="0">
      ...
      <div class="panel-body"> <?php echo form_open('child_rescued_list/ChilldRescuedRecord/create/', array('class' => 'form-horizontal form-groups-bordered validate project-add', 'enctype' => 'multipart/form-data','name'=> 'basicForm')); ?>
        ...
        <div class="row">
		 ...
		 <div class="col-sm-6">
              ...
              <div id="pin_code_fr_grp" class="col-sm-8 ">
               <!--<input type="text" class="form-control pin_code" name="pin_code" id="pin_code" 
				...
				<select name="pincode" class="form-control" id="pincode" >
                  ...
                  <option value="<?php echo $crow3['id'];?>" ><?php echo $crow3['pincode']; ?></option>
                  <?php  endforeach;  ?>
                </select>
            ...
            <div class="form-group">
              <label for="field-1" class="col-sm-3 control-label">21 b.i Enrollment Application No</label>
               <div id="adhar_card_enrollment_no_fr_grp" class="col-sm-8">
                <input type="text" class="form-control adhar_card_enrollment_no"  onkeypress="return isNumberKey(event)" name="adhar_card_enrollment_no" id="adhar_card_enrollment_no"  value="" autofocus>
            ...
            <div class="form-group">
              <label for="field-1" class="col-sm-3 control-label">21.b.ii Date Of Enrollment?</label>
			   ...
			   <div class="input-group date" id="datepicker_adhar"> <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                  <input type="text" class="form-control adhar_card_enrollment_date"  id="adhar_card_enrollment_date" name="adhar_card_enrollment_date"   data-validate="required"  >
                </div>
          ...
          <div class="col-sm-6"  id="adhar_card_yes">
            <div class="form-group">
              <label for="field-1" class="col-sm-3 control-label">21 b. Adhar Card ID</label>
              <div id="adhar_card_fr_grp" class="col-sm-8">
                <input type="text" class="form-control adhar_card"  onkeypress="return isNumberKey(event)" name="adhar_card" id="adhar_card"  value="" autofocus>
          ...
          <div class="col-sm-6" id="ename">
            <div class="form-group">
              ...
              <div id="iemployer_name_fr_grp" class="col-sm-8">
                <input type="text" class="form-control iemployer_name" name="iemployer_name" id="iemployer_name"  data-validate="required" />
          ...
          <div class="col-sm-6">
            <div class="form-group">
              ...
              <div id="wcontact_no_fr_grp" class="col-sm-8">
               <input type="text" class="form-control wcontact_no" name="wcontact_no" id="wcontact_no" onkeypress="return isNumberKey(event)"
                                value="" autofocus />
          ...
          <div class="col-sm-6">
            <div class="form-group">
              ...
              <div class="col-sm-8">
                  ...
                  <option value="Hotel/Dhaba">Hotel/Dhaba</option>
                  <option value="Flat/Houses">Flat/Houses</option>
          ...
          <div class="col-sm-6">
            <div class="form-group">
              ...
              <div class="col-sm-8">
                ...
                <option value="Uncordial">Uncordial</option>
                <option value="Other">Other</option>
                </select>
              </div>
        ...
        <div class="row padd-top">
          ...
          <div class="col-sm-6">
            ...
            <div class="col-md-3 right-margin" >
              ...
              <input type="number" class="form-control" name="working_days" id="working_days" min="0" max="7" autofocus="autofocus"  onKeyUp="if(this.value>7){this.value='7';}else if(this.value<0){this.value='0';}" />
            </div>
            <div class="col-md-3 right-margin">
              <label for="field-1" class="control-label">Hour(s) of Work</label>
              <input type="number" class="form-control" name="working_hours"  value="" id="working_hours"  min="0" max="24" autofocus="autofocus" onKeyUp="if(this.value>24){this.value='24';}else if(this.value<0){this.value='0';}"   />
            </div>
          </div>
        ...
        <div class="row padd-top">
          ...
          <div class="col-sm-6">
            ...
            <div class="col-md-3" class="right-margin" >
              <label for="field-1" class="control-label">Days</label>
              <input type="number" class="form-control" name="oworking_days" id="oworking_days" min="0" max="7" onKeyUp="if(this.value>7){this.value='7';}else if(this.value<1){this.value='1';}"autofocus="autofocus"  />
            </div>
            <div class="col-md-3 right-margin">
              <label for="field-1" class="control-label">Hour(s) of Work</label>
              <input type="number" class="form-control"  name="oworking_hours" id="oworking_hours"  value="" min="0" max="24" onKeyUp="if(this.value>24){this.value='24';}else if(this.value<0){this.value='0';}"autofocus="autofocus"  />
            </div>
          </div>
