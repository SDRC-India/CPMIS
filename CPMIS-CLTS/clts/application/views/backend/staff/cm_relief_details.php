...
<div class=""> <button type="button" class="btn btn-info pull-right" id="back" style="margin-bottom: 7px;">Back To List</button></div>
...
<table class="table table-bordered datatable min-height" id="table_export">
  ...
  <thead>
    <tr>
      ...
      <th style="text-align:center;color:#000;"><div>Physically Verified</div></th>
      <th style="text-align:center;color:#000;"><div>Eligible For CM Relief Fund</div></th>
       <?php if($cond_val=="No"){ ?>
...
window.location.assign('<?php echo base_url(); ?>index.php?dashboard/get_cm_relief_data/'+from+'/'+to+'/'+dist+'/'+cond+'/'+cond_val+'/'+export_type);
});
...
link.click();
	...
	$(function() {
	 ...
	 $(function() {
		  $("#back" ).click(function(){ console.log("ddd");window.history.back() });
		 });
