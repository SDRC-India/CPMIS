...
<table class="table table-bordered datatable" id="table_export">
  <thead>
    <tr>
      ...
      <th><div>Details of Delinquent<br/> Behaviour (if any)</div></th>
      <th><div>Reason for Delinquent</br> Behaviour</div></th>
      <th><div>Habits</div></th>
	  <th><div>Nature</div></th>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><?php echo $row['detail_delinquent'];	?>
      </td>
      <td><?php	echo $row['reason_delinquent'];?>
      </td>
      <td><?php	echo $row['habit'];
			?>
      </td>
	  <td><?php	echo $row['nature'];?>
      </td>
