		 ...
		 <?php  if($type==Parents){?>
			<thead>
				<tr>
					...
					<th style="text-align:center;width:20%;color:#000;">Name of the parents</th>
					<th style="text-align:center;width:20%;color:#000;">Parent Address</th>
					<th style="text-align:center;width:20%;color:#000;">Date</th>
				</tr>
			</thead>
			<tbody>
		...
		<?php }else if($type==cci){?>
			<thead>
				<tr>
					...
					<th style="text-align:center;color:#000;">Child Id</th>
					<th style="text-align:center;width:20%;color:#000;">Child Name</th>
					<th style="text-align:center;width:20%;color:#000;">Name of the cci</th>
					<th style="text-align:center;width:20%;color:#000;">cci Address</th>
					<th style="text-align:center;width:20%;color:#000;">Date</th>
				</tr>
			</thead>
			<tbody>
		...
		<?php }else if($type==fit_person){?>
			...
			<thead>
				<tr>
					...
					<th style="text-align:center;color:#000;">Child Id</th>
					<th style="text-align:center;width:20%;color:#000;">Child Name</th>
					<th style="text-align:center;width:20%;color:#000;">Name of the Fit Person</th>
					<th style="text-align:center;width:20%;color:#000;">Fit Person Address</th>
					<th style="text-align:center;width:20%;color:#000;">Date</th>
				</tr>
			</thead>
		...
		<?php }else if($type==fit_institution){?>
			...
			<thead>
				<tr>
					...
					<th style="text-align:center;color:#000;">Child Id</th>
					<th style="text-align:center;width:20%;color:#000;">Child Name</th>
					<th style="text-align:center;width:20%;color:#000;">Name of the Fit facilityn</th>
					<th style="text-align:center;width:20%;color:#000;">Fit facility Address</th>
					<th style="text-align:center;width:20%;color:#000;">Date</th>
				</tr>
			</thead>
		...
		<?php }else if($type==otherplace){?>
			...
			<thead>
				<tr>
					...
					<th style="text-align:center;color:#000;">Child Id</th>
					<th style="text-align:center;width:20%;color:#000;">Child Name</th>
					<th style="text-align:center;width:20%;color:#000;">Name of the otherplace</th>
					<th style="text-align:center;width:20%;color:#000;">otherplace Address</th>
					<th style="text-align:center;width:20%;color:#000;">Date</th>
				</tr>
			</thead>
...
window.location.assign('<?php echo base_url(); ?>index.php?mis_reports/child_order_after_list/'+from+'/'+to+'/'+type+'/'+area+'/'+export_type);
});
