...
<table class="table table-bordered datatable" id="table_export">
  <thead>
    <tr>
      ...
      <th><div>Type of Family</div></th>
      <th><div>Has Family Migrated</div></th>
      <th><div>Relationship Among the Family Members(Father &amp; Mother)</div></th>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><?php	echo $row['type_of_family'];?>
      </td>
      <td><?php  echo $row['is_family_migrate'];	?>
      </td>
      <td><?php echo $row['father_mother'];
