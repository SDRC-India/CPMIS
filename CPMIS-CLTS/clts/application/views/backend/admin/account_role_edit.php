	...
	<div class="col-md-12">
		<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body">
                ...
                <?php echo form_open('admin/account_role/edit/'.$row['account_role_id'], array('class' => 'form-horizontal form-groups-bordered validate ajax-submit1', 'enctype' => 'multipart/form-data'));?>
