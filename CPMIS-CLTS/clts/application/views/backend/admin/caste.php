...
<table class="table table-bordered datatable" id="table_export">
	<thead>
		<tr>
			...
			<th><div><?php echo get_phrase('caste_category');?></div></th>
			<th><div><?php echo get_phrase('Caste_Name');?></div></th>
			...
			<td>
            	<div class="btn-group">
                  ...
                  <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                      ...
                      <!-- EDITING LINK -->
                      <li>
                          <a href="#" onclick="showAjaxModal('<?php echo $editcaste_url.$row['id'];?>');">
