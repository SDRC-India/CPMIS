	...
	<div class="col-md-12">
		<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body">
                ...
                <?php echo form_open('admin/account_role/create/' , array('class' => 'form-horizontal form-groups validate ajax-submit12', 'enctype' => 'multipart/form-data'));?>
...
<script src="assets/js/ajax-form-account-submission.js"></script>
