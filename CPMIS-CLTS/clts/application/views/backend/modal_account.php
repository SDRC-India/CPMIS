	...
	function showAjaxModal2(url)
	{
		...
		jQuery('#modal_ajax2 .modal-body').html('<div style="text-align:center;margin-top:200px;"><img src="assets/images/preloader.gif" style="height:25px;" /></div>');
		 window.scrollTo(0,0);
		// LOADING THE AJAX MODAL
		jQuery('#modal_ajax2').modal('show', {backdrop: 'true'});
		...
		$.ajax({
			...
			{
				jQuery('#modal_ajax2 .modal-body').html(response);
			}
		});
	}
	</script>
